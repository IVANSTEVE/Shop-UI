        ...
        <div className="background">
            ...
            <Navbar bg="dark" variant="dark" expand="lg" className="main-navbar">
                <Container className="justify-content-center">
                    <Navbar.Brand onClick={() => setSelectedCategory(null)} style={{ cursor: 'pointer', display: 'flex', alignItems: 'center' }}>
            ...
            <main className="content">
                {selectedCategory && !selectedProduct ? (
                    ...
                    <HomeScreen categories={categories} setSelectedCategory={setSelectedCategory} setSelectedProduct={setSelectedProduct}/>
                )}
            </main>
            <Footer />
        </div>
    ...
    return (
        <div className="home-screen text-center my-4">
            ...
            <p className="futuristic-paragraph">
                Ce site a été réalisé dans le cadre du cours de Projet d'Intégration. Découvrez notre sélection de t-shirts et explorez les différentes catégories disponibles. 
                Ce projet utilise React pour le front-end, Spring Boot pour le back-end, et MySQL pour la gestion de données.
            </p>
